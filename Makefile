...
.DEFAULT_GOAL := help
.PHONY: greet blog calculator primes average help
project := greet calculator blog primes average
...
clean: clean_greet clean_calculator clean_blog clean_primes clean_average ## Clean generated files
	${RM_F_CMD} ssl/*.crt
	${RM_F_CMD} ssl/*.csr
	${RM_F_CMD} ssl/*.key
	${RM_F_CMD} ssl/*.pem
